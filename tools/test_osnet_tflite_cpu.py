...
MODELS = {
    "osnet_x1_0_msmt17 fp16 (shipped baseline, app/src/main/assets/)":
        REPO / "app/src/main/assets/osnet_x1_0_msmt17.tflite",
    "osnet_x1_0_msmt17 fp32 (pre-quant reference)":
